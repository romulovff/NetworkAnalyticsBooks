...
dt.books$n_books_class <- with(dt.books, ifelse(n.books >= 0 & n.books < 10, "[0-10[", ifelse(n.books >= 10 & n.books < 20, "[10 -20[", ifelse(n.books >= 20 & n.books < 30, "[20-30[", ifelse(n.books >= 30 & n.books < 40, "[30-40[", ifelse(n.books >= 40 & n.books <= 50, "[40-50]", "NA"))))))
```
